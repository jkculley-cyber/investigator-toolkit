...
function buildCover() {
  ...
  const steps = [
    ...
    '12. Questions? Email: support@clearpathedgroup.com',
  ]
  ...
  setStr(ws, 30, 0, '© 2025 Clear Path Education Group, LLC  |  clearpathedgroup.com  |  For organizational use only — not legal advice.')
  merge(ws, 'A31:J31')
...
function buildDashboard() {
  ...
  setStr(ws, r, 0, '© 2025 Clear Path Education Group, LLC  |  clearpathedgroup.com  |  Upgrade to Navigator for real-time, automated tracking.')
  merge(ws, `A${r+1}:J${r+1}`)
...
function buildReference() {
  ...
  rows.push(['Clear Path Education Group, LLC  |  clearpathedgroup.com  |  For organizational use only', '', '', ''])
  rows.push(['', '', '', ''])
  ...
  rows.push(['', '', '', ''])
  rows.push(['© 2025 Clear Path Education Group, LLC  |  clearpathedgroup.com  |  For organizational use only', '', '', ''])
...
function buildUpgrade() {
  ...
  rows.push(['Clear Path Education Group, LLC  |  clearpathedgroup.com/navigator', '', ''])
  rows.push(['', '', ''])
  ...
  rows.push(['→ Learn more:        clearpathedgroup.com/navigator', '', ''])
  rows.push(['→ Email:             sales@clearpathedgroup.com', '', ''])
  rows.push(['', '', ''])
...
function buildRiskAlertBoard() {
  ...
  setStr(ws, r, 0, '─── Generated by Navigator — Student Behavior Tracker | Clear Path Education Group, LLC | clearpathedgroup.com ───')
