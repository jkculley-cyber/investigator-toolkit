        ...
        <div className="space-y-4">
          ...
          <Card className="px-5 py-4">
            ...
            <div className="space-y-2">
              <button className="w-full px-4 py-2.5 bg-red-600 text-white text-xs font-semibold rounded-lg hover:bg-red-700 transition-colors text-left">
                Escalate to SPED Director
              </button>
              <button className="w-full px-4 py-2.5 bg-purple-600 text-white text-xs font-semibold rounded-lg hover:bg-purple-700 transition-colors text-left">
                Schedule ARD Meeting
              </button>
              <button className="w-full px-4 py-2.5 bg-gray-100 text-gray-700 text-xs font-semibold rounded-lg hover:bg-gray-200 transition-colors text-left">
