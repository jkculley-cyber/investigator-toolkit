...
function buildCover() {
  ...
  setStr(ws, 33, 0, '© 2025 Clear Path Education Group, LLC  |  clearpathedgroup.com  |  For organizational use only — not legal advice.')
  merge(ws, 'A34:L34')
...
function buildDashboard() {
  ...
  setStr(ws, r, 0, '© 2025 Clear Path Education Group, LLC  |  clearpathedgroup.com  |  Upgrade to Meridian for automated compliance tracking.')
  merge(ws, `A${r+1}:L${r+1}`)
...
function buildUpgrade() {
  ...
  rows.push(['Clear Path Education Group, LLC  |  clearpathedgroup.com/meridian', '', ''])
  rows.push(['', '', ''])
  ...
  rows.push(['→ Learn more:        clearpathedgroup.com/meridian', '', ''])
...
function buildComplianceHealthBoard() {
  ...
  setStr(ws, r, 0, '─── Generated by Meridian — SPED Compliance Tracker | Clear Path Education Group, LLC | clearpathedgroup.com ───')
