  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <img src="/logo.png" alt="Waypoint" className="h-40 w-40 mx-auto mb-6 object-contain" />
      ...
      <footer className="bg-gray-900 text-gray-400 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Waypoint. All rights reserved.</p>
          <p className="text-xs text-gray-500 mt-2">&copy; 2026 Clear Path Education Group, LLC. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
