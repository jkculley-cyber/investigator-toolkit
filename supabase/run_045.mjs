...
const sql = readFileSync(join(__dirname, 'migrations', '045_fix_function_search_paths.sql'), 'utf-8')
console.log('Applying 045_fix_function_search_paths.sql...')
await client.query(sql)
console.log('✓ 045_fix_function_search_paths.sql applied.')
